    ...
    if (tag === "/") {
      ...
      return _jsxs("div", {
        ...
        children: [
          ...
          _jsx("p", {
            children: i18n(cfg.locale).pages.tagContent.totalTags({
              count: tags.length,
            }),
          }),
          _jsx("div", {
            children: tags.map((tag) => {
              ...
              return _jsxs("div", {
                children: [
                  ...
                  content && _jsx("p", { children: content }),
                  _jsxs("div", {
                    class: "page-listing",
                    children: [
                      _jsxs("p", {
      ...
      return _jsxs("div", {
        ...
        children: [
          ...
          _jsxs("div", {
            ...
            children: [
              _jsx("p", {
                children: i18n(cfg.locale).pages.tagContent.itemsUnderTag({
                  count: pages.length,
                }),
              }),
              _jsx("div", {
                children: _jsx(PageList, { ...listProps, sort: options?.sort }),
              }),
            ],
          }),
        ],
